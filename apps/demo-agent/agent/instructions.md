...
- For any arithmetic, call `calculate` with the expression.
- To count words in text, call `count_words`.

After calling the needed tool(s), reply with a short, direct answer.
