...
describe("version gate", () => {
  ...
  it("accepts only stable Eve releases in the supported compatibility window", () => {
    expect(SUPPORTED_EVE_RANGE).toBe(">=0.25.0 <0.28.0");
    expect(supportsEveVersion("0.25.0")).toBe(true);
    expect(supportsEveVersion("0.25.3")).toBe(true);
    expect(supportsEveVersion("0.26.0")).toBe(true);
    expect(supportsEveVersion("0.27.0")).toBe(true);
    expect(supportsEveVersion("0.27.12")).toBe(true);
    expect(supportsEveVersion("0.27.99")).toBe(true);
    expect(supportsEveVersion("0.24.6")).toBe(false);
    expect(supportsEveVersion("0.22.4")).toBe(false);
    expect(supportsEveVersion("0.17.2")).toBe(false);
    expect(supportsEveVersion("0.28.0")).toBe(false);
    expect(supportsEveVersion("1.0.0")).toBe(false);
    expect(supportsEveVersion("0.27.4-beta.1")).toBe(false);
    expect(supportsEveVersion("0.27.4+build.1")).toBe(false);
    expect(supportsEveVersion(" 0.27.4 ")).toBe(false);
    expect(supportsEveVersion("0.27.999999999999999999999")).toBe(false);
